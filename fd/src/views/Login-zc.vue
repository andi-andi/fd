        ...
        <div class="container">
            <div class="login">
                ...
                <div class="login-f text-center">
                    <div class="login-img"><img src="/images/icon/log.png" alt="" class="w-100"></div>
                ...
                <div class="login-nr">
                    ...
                    <div class="w-100 next">
                        ...
                        <div class="marign mb-2">
                            ...
                            <a target="_blank" href="https://im.qq.com/"><img src="/images/icon/icon14.png" title="QQ"></a>
                            <a target="_blank" href="https://weixin.qq.com/"><img src="/images/icon/icon15.png" title="微信"></a>
                            <a target="_blank" href="http://www.google.cn/"><img src="/images/icon/icon1.1.png" title="谷歌"></a>
                        </div>
    ...
    export default {
        ...
        methods:{
           ...
           //失去焦点时 让span隐藏
            ...
            none0(){this.upwduw=""},
            postuser(){
                if(this.uname() && this.password() && this.upwdqr() ){
                    this.spanuser="";this.upwdinner="";this.upwduw="";
                    this.axios.post("users/loginzc",`uname=${this.user}&upwd=${this.upwd}`).then(result=>{
                        if(result.data.affectedRows==1){
                            this.$store.commit('login_mutation')
                            sessionStorage.setItem("isLogin",true)
                            this.$message({
                                message:'注册成功 3s后自动跳转首页',
                                type:'success'
                            });
                            setTimeout(()=>{
                                this.$router.push("/")
